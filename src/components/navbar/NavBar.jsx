...
const NavBar = () => {
  ...
  return (
    <div className="fixed z-10 bg-white border-b md:mb-10 border-gray-300 max-w-7xl md:mx-auto top-0 w-full flex items-center justify-between flex-row px-5 py-3 md:px-5">
      <ButtonWithLogo
        onClick={navigateTo("/")}
        align="row"
        imageSize="h-12 w-12"
